namespace UIMarkup.UI.UnoApp.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.UIMarkup.UI.UnoApp";
    public readonly static string AndroidAppName = "com.companyname.UIMarkup.UI.UnoApp";
